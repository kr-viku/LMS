...
export const DisplayTextCard: React.FC<DisplayTextCardProps> = ({card,updateContentCardControl}) =>{
    ...
    <div className="DisplayTextCard">
        ...
        <Card className="ImageUpload Display">
            ...
            <Card.Body className="DisplayText" dangerouslySetInnerHTML={{__html:card.content.Text || ""}} >
