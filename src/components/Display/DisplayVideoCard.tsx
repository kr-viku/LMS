...
export const DisplayVideoCard: React.FC<DisplayVideoCardProps> = ({card,updateContentCardControl}) =>{
    ...
    return(
    <div className="DisplayVideoCard">
         {
        comment &&
        ...
        <Card className="ImageUpload Display">
            ...
            <Card.Body>
                <div className="DisplayVideoCaption">
